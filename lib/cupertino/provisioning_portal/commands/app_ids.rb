...
command :'app_ids:add' do |c|
  c.syntax = 'ios app_ids:add'
  c.summary = 'Add an App IDs'
  c.description = ''

  c.action do |args, options|
    
    type = args.first.downcase.to_sym rescue nil
    agent.add_app_id('TestCupertino', 'com.robotsandpencils.testcupertino.ent')
...
alias_command :app_ids, :'app_ids:list' #, :'app_ids:add'
